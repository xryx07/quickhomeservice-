...
const ProviderTerms = () => {
  ...
  const providerImage = "/provider-agreement.jpg"; // This would be replaced with your actual image path

  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg">
      {/* Front page with image */}
      <div className="relative h-40 rounded-t-lg overflow-hidden mb-6">
        <div className="absolute inset-0 bg-gradient-to-r from-brand-600/80 to-blue-600/80 z-10"></div>
        <div 
          className="absolute inset-0 bg-cover bg-center z-0" 
          style={{ 
            backgroundImage: `url(${providerImage})`,
            backgroundImage: `url('https://images.unsplash.com/photo-1521791136064-7986c2920216?q=80&w=1000&auto=format&fit=crop')` 
          }}
        ></div>
        <div className="absolute inset-0 flex items-center justify-center z-20">
          <div className="text-center text-white">
            <ShieldCheck className="h-12 w-12 mx-auto mb-2" />
            <h1 className="text-2xl font-bold">Provider Agreement</h1>
            <p className="text-sm mt-1">Terms and Conditions for Service Providers</p>
          </div>
        </div>
      </div>
            ...
            <div className="prose prose-blue max-w-none dark:prose-invert">
              ...
              <Accordion type="single" collapsible className="my-6">
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent className="text-gray-700 dark:text-gray-300 space-y-2">
